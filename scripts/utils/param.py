...
class globalParam:
    ...
    GAZEBO_MODEL_PATH           = os.path.abspath(os.path.join(OUTPUT_BASE_PATH,'gazebo_terrain'))
    GAZEBO_WORLD_PATH           = os.path.abspath(os.path.join(OUTPUT_BASE_PATH,'gazebo_terrain/worlds'))
    DEM_RESOLUTION              = 13
